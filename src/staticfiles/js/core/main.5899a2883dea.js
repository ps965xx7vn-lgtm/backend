...
class LanguageManager {
  ...
  setupSwitchers() {
    ...
    switchers.forEach(switcher => {
      const trigger = switcher.querySelector('[data-dropdown-trigger]');
      const dropdown = switcher.querySelector('[data-dropdown-menu]');
      ...
      // Обновить активные опции
      this.updateOptions(switcher);
    });
  }
  ...
  updateTrigger(trigger) {
    const flagElement = trigger.querySelector('[data-current-flag]');
    const langElement = trigger.querySelector('[data-current-lang]');
  ...
  changeLanguage(langCode) {
    if (this.languages[langCode]) {
      ...
      if (window.notificationManager) {
        window.notificationManager.show(`Язык изменен на ${this.languages[langCode].name}`, 'success', 2000);
      }
...
function initHeader() {
  ...
  dropdowns.forEach(dropdown => {
    ...
    console.log('Dropdown:', dropdown, 'Trigger:', trigger, 'Menu:', menu);
    ...
    if (trigger && menu) {
      trigger.addEventListener('click', (e) => {
        ...
        console.log('Dropdown clicked, current classList:', dropdown.classList);
        ...
        console.log('После toggle classList:', dropdown.classList, 'open:', dropdown.classList.contains('open'));
      });
    }
  });
  ...
  document.addEventListener('click', (e) => {
    ...
    console.log('Clicked inside dropdown:', clickedInside);
