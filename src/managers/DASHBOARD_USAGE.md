...
Manager Dashboard - полнофункциональная административная панель для управления платформой Pyland.

## Доступ

**URL:** `<http://localhost:8000/ru/managers/`> (или `/en/managers/` для английской версии)
