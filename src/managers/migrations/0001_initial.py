    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.CharField(db_index=True, max_length=200, verbose_name="Email адрес"),
                ),
                (
                    "topic",
                    models.CharField(
                ...
                (
                    "is_processed",
                    models.BooleanField(db_index=True, default=False, verbose_name="Обработано"),
                ),
                (
                    "processed_at",
                ...
                (
                    "admin_notes",
                    models.TextField(blank=True, null=True, verbose_name="Заметки администратора"),
                ),
                (
                    "processed_by",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_agent",
                    models.CharField(blank=True, max_length=255, verbose_name="User Agent"),
                ),
                ("message", models.TextField(verbose_name="Сообщение")),
