    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Краткое описание категории", verbose_name="Описание"
                    ),
                ),
                (
                    "icon",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        blank=True, help_text="Имя подписчика", max_length=100, verbose_name="Имя"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "allow_comments",
                    models.BooleanField(default=True, verbose_name="Разрешить комментарии"),
                ),
                (
                    "author",
                    models.ForeignKey(
                ...
                (
                    ...
                    taggit.managers.TaggableManager(
                        blank=True,
                        help_text="Теги для статьи, разделенные запятыми",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="Дата жалобы"
                    ),
                ),
                (
                    "reviewed_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Дата рассмотрения"),
                ),
                (
                    "article",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "referer",
                    models.URLField(blank=True, null=True, verbose_name="Источник перехода"),
                ),
                (
                    "time_on_page",
                    models.PositiveIntegerField(default=0, verbose_name="Время на странице (сек)"),
                ),
                (
                    "scroll_depth",
                    models.PositiveIntegerField(default=0, verbose_name="Глубина прокрутки (%)"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(max_length=100, unique=True, verbose_name="URL-адрес профиля"),
                ),
                (
                    "bio",
                    models.TextField(
                        help_text="Краткая биография автора", verbose_name="Биография"
                    ),
                ),
                (
                    "specializations",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Имя пользователя GitHub",
                        max_length=50,
                        verbose_name="GitHub",
                    ),
                ),
                ...
                (
                    "articles_count",
                    models.PositiveIntegerField(default=0, verbose_name="Количество статей"),
                ),
                (
                    "total_views",
                    models.PositiveIntegerField(default=0, verbose_name="Общие просмотры"),
                ),
                (
                    "total_reactions",
                    models.PositiveIntegerField(default=0, verbose_name="Общие реакции"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Отображается ли комментарий на сайте",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Название серии статей",
                        max_length=200,
                ...
                (
                    "slug",
                    models.SlugField(max_length=200, unique=True, verbose_name="URL-адрес серии"),
                ),
                (
                    "description",
                    models.TextField(
                        help_text="Краткое описание того, о чем серия статей",
                ...
                (
                    "meta_description",
                    models.CharField(blank=True, max_length=160, verbose_name="Meta описание"),
                ),
                (
                    "author",
                    models.ForeignKey(
                ...
                (
                    ...
                    taggit.managers.TaggableManager(
                        blank=True,
                        help_text="Теги для категоризации серии",
                        through="taggit.TaggedItem",
                        to="taggit.Tag",
                        verbose_name="Теги",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Папка для группировки закладок",
                        max_length=100,
                        verbose_name="Папка",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "progress_percentage",
                    models.PositiveIntegerField(default=0, verbose_name="Прогресс чтения (%)"),
                ),
                (
                    "reading_time_seconds",
                    models.PositiveIntegerField(default=0, verbose_name="Время чтения (сек)"),
                ),
                (
                    "status",
                    models.CharField(
