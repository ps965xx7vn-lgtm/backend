...
- [Обзор](#обзор)
- [markdown_filters.py](#markdown_filterspy)
- [article_tags.py](#article_tagspy)
- [Использование](#использование)
- [Примеры](#примеры)

## 🎯 Обзор

В папке `templatetags/` находятся пользовательские template tags для расширения функциональности Django шаблонов.
